...
export default function MonthlyTarget({
  ...
  const series = useMemo(() => [Math.min(100, Math.max(0, activePercent))], [activePercent]);
    ...
    return (
      <div className="rounded-2xl border border-gray-200 bg-gray-100 dark:border-gray-800 dark:bg-white/[0.03] animate-pulse">
        <div className="px-5 pt-5 bg-white shadow-default rounded-2xl pb-11 dark:bg-gray-900 sm:px-6 sm:pt-6">
          ...
          <div className="h-[330px] rounded-lg bg-gray-100 dark:bg-gray-800 mt-4" />
        </div>
      </div>
    );
  }
    ...
    <div className="rounded-2xl border border-gray-200 bg-gray-100 dark:border-gray-800 dark:bg-white/[0.03]">
      <div className="px-5 pt-5 bg-white shadow-default rounded-2xl pb-11 dark:bg-gray-900 sm:px-6 sm:pt-6">
        <div className="flex justify-between">
          <div>
            ...
            <p className="mt-1 text-gray-500 text-theme-sm dark:text-gray-400">
              Share of listings still active on the market
            </p>
          </div>
        ...
        <div className="relative ">
          ...
          >
            {revenueTrend === "up" ? "+" : ""}
            {revenueMomPct.toFixed(1)}% revenue vs last month
          </span>
        </div>
        <p className="mx-auto mt-10 w-full max-w-[380px] text-center text-sm text-gray-500 sm:text-base">
          Confirmed revenue this month:{" "}
          <span className="font-medium text-gray-800 dark:text-white/90">
            {formatMoney(revenueThisMonth, currency)}
          </span>
          . New listings today:{" "}
          <span className="font-medium text-gray-800 dark:text-white/90">
            {newListingsToday}
