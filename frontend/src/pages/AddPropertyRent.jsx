						...
						<div className="card add-tab-sticky border-0">
							<div className="card-body">
								<ul className="add-tab-list">
									<li>
										<Link to="/add-property-rent" className="active">Property Information</Link>
									</li>
									<li>
										<Link to="/add-property-rent">Property Details</Link>
									</li>
									<li>
										<Link to="/add-property-rent">Amenities</Link>
									</li>
									<li>
										<Link to="/add-property-rent">Gallery</Link>
									</li>
									<li>
										<Link to="/add-property-rent">Videos</Link>
									</li>
									<li>
										<Link to="/add-property-rent">Description</Link>
									</li>
									<li>
										<Link to="/add-property-rent">Location</Link>
									</li>
								</ul>
							</div>
						</div>
						<form action="add-property-rent.html">
												...
												<div className="card-body">
													<div className="d-flex align-items-center">
														<div className="selected-imgs">
															...
															<Link to="/add-property-rent" className="delete-circle"><i className="material-icons-outlined">delete</i></Link>
														</div>
														<div className="selected-imgs">
													...
													<div className="mb-3">
														...
														<div className="file-uploader">
															...
															<Link to="/add-property-rent" className="input-file">
