...
/** Same visibility rules as RentPropertyGrid */
					...
					<div className="breadcrumb-bar">
						...
						<div className="row align-items-center text-center position-relative z-1">
							<div className="col-md-12 col-lg-12 col-md-6 breadcrumb-arrow">
								<h1 className="breadcrumb-title">Rent List</h1>
						...
						<div className="container">
							...
							{!loading && !error && properties.length === 0 && totalResults === 0 && (
								<div className="text-center py-5">
									...
									<p className="text-muted">Try another page or adjust filters</p>
								</div>
							)}
													...
													<div className="property-listing-item p-0 mb-0 shadow-none d-flex flex-lg-nowrap flex-wrap">
														<div className="buy-grid-img buy-list-img rent-list-img mb-0 rounded-0">
															...
															<div className="d-flex align-items-center justify-content-between position-absolute bottom-0 end-0 start-0 p-3 z-1">
																<h6 className="text-white mb-0">
																	...
																	<span className="fs-14 fw-normal">/ month</span>
																</h6>
																<button type="button" className="favourite btn btn-link p-0 border-0 bg-transparent text-white">
														...
														<div className="buy-grid-content w-100">
															<div className="d-flex align-items-center justify-content-between mb-3">
																...
																{property.type && <span className="badge bg-secondary">{property.type}</span>}
															</div>
															<div className="d-flex align-items-center justify-content-between mb-3">
																<div>
