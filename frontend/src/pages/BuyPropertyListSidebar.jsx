            ...
            <div className="breadcrumb-bar">
                ...
                <div className="row align-items-center text-center position-relative z-1">
                    <div className="col-md-12 col-12 breadcrumb-arrow">
                        <h1 className="breadcrumb-title">Buy List Sidebar</h1>
                        <nav aria-label="breadcrumb" className="page-breadcrumb">
                            <ol className="breadcrumb">
                                ...
                                <li className="breadcrumb-item active" aria-current="page">Buy List Sidebar</li>
                            </ol>
                        </nav>							
                    </div>
                </div>
                ...
                <div className="container">
                                ...
                                <div className="col-lg-9">
                                    <div className="d-flex align-items-center gap-3 flex-wrap justify-content-lg-end flex-lg-row flex-md-row flex-column">
                                        ...
                                        <ul className="grid-list-view d-flex align-items-center justify-content-center">
                                            <li><Link to="/buy-property-list-sidebar"  className="list-icon active"><i className="material-icons">list</i></Link></li>
                                            <li><Link to="/buy-property-grid-sidebar" className="list-icon "><i className="material-icons">grid_view</i></Link></li>
                                            <li><Link to="/buy-list-map" className="list-icon"><i className="material-icons-outlined">location_on</i></Link></li>
                                        </ul>
                                    </div>
                                </div> 
                            </div>
                    ...
                    <div className="row">
                        <div className="col-xl-3 col-lg-12 theiaStickySidebar">
							<div className="filter-sidebar buy-grid-sidebar-item-02 mb-xl-0">
								<div className="filter-head d-flex align-items-center justify-content-between">
									<h5 className="mb-0">Filter</h5>
									<Link to="/buy-property-list-sidebar" className="text-danger">Reset</Link>
								</div>
                                ...
                                <div className="filter-footer">
                                    <Link to="/buy-property-list-sidebar" className="btn btn-dark w-100"> Apply Filter </Link>
                                </div>
							</div>
						</div>  
                                                    ...
                                                    <div>
                                                        <div className="d-flex align-items-center justify-content-between mb-3">
                                                            <div className="d-flex align-items-center justify-content-center">
                                                                ...
                                                                <i className="material-icons-outlined text-warning">star</i>
                                                                <i className="material-icons-outlined text-warning">star</i>
                                                                <span className="ms-1 fs-14">4.7 (42 Reviews)</span>
                                                            </div>
                                                        </div>
                                                        <div className="d-flex align-items-center justify-content-between">
                                                            <div>
                                                    ...
                                                    <div>
                                                        <div className="d-flex align-items-center justify-content-between mb-3">
                                                            <div className="d-flex align-items-center justify-content-center">
                                                                ...
                                                                <i className="material-icons-outlined text-warning">star</i>
                                                                <i className="material-icons-outlined text-warning">star</i>
                                                                <span className="ms-1 fs-14">4.9 (81 Reviews)</span>
                                                            </div>
                                                        </div>
                                                        <div className="d-flex align-items-center justify-content-between">
                                                            <div>
