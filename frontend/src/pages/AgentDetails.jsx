		...
		<div className="breadcrumb-bar">
			...
			<div className="row align-items-center text-center position-relative z-1">
				<div className="col-md-12 col-12 breadcrumb-arrow">
					<h1 className="breadcrumb-title">Agent Details</h1>
			...
			<div className="container">
				<div className="agent-profile-item">
					<div className="agent-img">
						<img src="/assets/img/agents/agent-01.jpg" alt="" />
					</div>
					<div className="agent-content flex-fill">
						...
						<div className="d-flex align-items-center justify-content-between border-bottom flex-wrap row-gap-3 pb-3 mb-3">
							...
							<div className="d-flex align-items-center">
								<Link to="/agent-details" className="btn btn-primary d-inline-flex align-items-center me-2"><i className="material-icons-outlined me-1">chat_bubble_outline</i>WhatsApp</Link>
								<Link to="/agent-details" className="btn btn-dark d-inline-flex align-items-center"><i className="material-icons-outlined me-1">call</i>Call Me</Link>
							</div>
						</div>
						...
						<div className="border-top position-relative mt-3 pt-3 mb-4 mb-lg-0">
							...
							<ul className="nav nav-pills listing-nav" role="tablist">
								<li className="nav-item" role="presentation">
									<Link className="nav-link active" data-bs-toggle="tab" to="/agent-details" role="tab" aria-controls="listing-1" aria-selected="true"> 
										<i className="material-icons-outlined me-2">maps_home_work</i>All Properties (25)
									</Link>
								</li>
								<li className="nav-item" role="presentation">
									<Link className="nav-link" data-bs-toggle="tab" to="/agent-details" role="tab" aria-controls="listing-2" aria-selected="false" tabIndex="-1">
										<i className="material-icons-outlined me-2">apartment</i>Apartment
									</Link>
								</li>
								<li className="nav-item" role="presentation">
									<Link className="nav-link" data-bs-toggle="tab" to="/agent-details" role="tab" aria-controls="listing-3" aria-selected="false" tabIndex="-1">
										<i className="material-icons-outlined me-2">corporate_fare</i>Condos
									</Link>
								</li>
								<li className="nav-item" role="presentation">
									<Link className="nav-link" data-bs-toggle="tab" to="/agent-details" role="tab" aria-controls="listing-4" aria-selected="false" tabIndex="-1">
					...
					<div className="col-lg-4 theiaStickySidebar">
						<div className="card">
							...
							<div className="card-body">
								...
								<div>
									<Link to="/agent-details" className="btn btn-dark w-100">Send Email</Link>
								</div>
							</div>
						</div>
						<div className="card">
						...
						<div className="card mb-0">
							...
							<div className="card-body">
								<div className="social-icons">
									<Link to="/agent-details"><i className="fa-brands fa-x-twitter"></i></Link>
									<Link to="/agent-details"><i className="fa-brands fa-facebook"></i></Link>
									<Link to="/agent-details"><i className="fa-brands fa-instagram"></i></Link>
									<Link to="/agent-details"><i className="fa-brands fa-linkedin"></i></Link>
									<Link to="/agent-details"><i className="fa-brands fa-pinterest"></i></Link>
								</div>
							</div>
						</div>
					</div>
