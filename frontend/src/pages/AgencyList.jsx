		...
		<div className="breadcrumb-bar">
			...
			<div className="row align-items-center text-center position-relative z-1">
				<div className="col-md-12 col-12 breadcrumb-arrow">
					<h1 className="breadcrumb-title">Agency List</h1>
					<nav aria-label="breadcrumb" className="page-breadcrumb">
						<ol className="breadcrumb">
							...
							<li className="breadcrumb-item active" aria-current="page">Agency List</li>
						</ol>
					</nav>							
				</div>
			</div>
		...
		<div className="content">
			<div className="container">
				...
				<div className="agent-list-item">
					...
					<div className="agent-content">
						...
						<div className="social-icons">
							<Link to="/agency-list"><i className="fa-brands fa-x-twitter"></i></Link>
							<Link to="/agency-list"><i className="fa-brands fa-facebook"></i></Link>
							<Link to="/agency-list"><i className="fa-brands fa-instagram"></i></Link>
							<Link to="/agency-list"><i className="fa-brands fa-linkedin"></i></Link>
							<Link to="/agency-list"><i className="fa-brands fa-pinterest"></i></Link>
						</div>
					</div>
				</div>
				...
				<div className="text-center pt-3">
					<Link to="/agency-list" className="btn btn-dark align-items-center d-inline-flex"><i className="material-icons-outlined me-1">autorenew</i>Load More</Link>
				</div>
