            ...
            <div className="breadcrumb-bar">
                ...
                <div className="row align-items-center text-center position-relative z-1">
                    <div className="col-md-12 col-12 breadcrumb-arrow">
                        <h1 className="breadcrumb-title">Rent Grid Sidebar</h1>
                        <nav aria-label="breadcrumb" className="page-breadcrumb">
                            <ol className="breadcrumb">
                                ...
                                <li className="breadcrumb-item active" aria-current="page">Rent Grid Sidebar</li>
                            </ol>
                        </nav>							
                    </div>
                </div>
                ...
                <div className="container">
                                ...
                                <div className="col-lg-9">
                                    <div className="d-flex align-items-center gap-3 flex-wrap justify-content-lg-end flex-lg-row flex-md-row flex-column">
                                        ...
                                        <ul className="grid-list-view d-flex align-items-center justify-content-center">
                                            <li><Link to="/rent-property-list-sidebar"  className="list-icon "><i className="material-icons">list</i></Link></li>
                                            <li><Link to="/rent-property-grid-sidebar" className="list-icon active"><i className="material-icons">grid_view</i></Link></li>
                    ...
                    <div className="row">
                        <div className="col-xl-4 theiaStickySidebar">
							<div className="filter-sidebar rent-grid-sidebar-item-02 mb-xl-0">
								<div className="filter-head d-flex align-items-center justify-content-between">
									<h5 className="mb-0">Filter</h5>
									<Link to="/rent-property-grid-sidebar" className="text-danger">Reset</Link>
								</div>
                                ...
                                <div className="filter-footer">
                                    <Link to="/rent-property-grid-sidebar" className="btn btn-dark w-100"> Apply Filter </Link>
                                </div>
							</div>
						</div>  
...
export default RentPropertyGridSidebar;
